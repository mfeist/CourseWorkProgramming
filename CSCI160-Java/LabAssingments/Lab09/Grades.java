...
/**
 * Demonstrate of importing text documents.
 * 
 * @author mfeist 
 * @version 3/1/2013
 */
...
public class Grades
{
   public static void main (String [] args) throws IOException
   {
       ...
       File inputFile = new File("Grades.txt");//instantiate and declared object reference.
       Scanner scan = new Scanner(inputFile);//instantiate and declared object reference.
     
       while (scan.hasNext())//loop to obtain all the grades and condition for when to stop.
       {
           grade = scan.nextInt();//obtains the next value from the text as an int.
