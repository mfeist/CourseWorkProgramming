...
public class NumberAdditionUI extends javax.swing.JFrame {
    ...
    while (incorrect){
        try{Float.parseFloat(number1);
        incorrect = false;
        }
        catch(NumberFormatException nfe){
            number1 = JOptionPane.showInputDialog("Invalid input. Please Enter First Number: ");
        }
    }
    boolean correct = true;
    while (correct){
        try{Float.parseFloat(number2);
        correct = false;
        }
        catch(NumberFormatException nfe){
            number2 = JOptionPane.showInputDialog("Invalid input. Please Enter Second Number: ");
        }
    }
